...
def test_epoch(model_root, fold, logger, best_model):   
    ...
    dev_set = Mydataset(dataset_type=args.dataset_type, mode='val', max_len_ls=max_len_ls, fold=fold, feature_ls=feature_ls, missing_rate=args.missing_rate, seed=seed)
    test_set = Mydataset(dataset_type=args.dataset_type, mode='test', max_len_ls=max_len_ls, fold=fold, feature_ls=feature_ls, missing_rate=args.missing_rate, seed=seed)  
...
def main(fold_list, fold_root):
    ...
    with open(os.path.join(args.test_root, 'test_modality_missing_seed_{}_{}_{}.txt'.format(seed,args.feature,args.model_type)),'a') as f:
